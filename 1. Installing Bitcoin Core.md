...
**Prerequisites.**
 - [ ] Intel/AMD 64-bit computer with [Debian](https://www.debian.org/download) install.
...
peerbloomfilters=1
```
Leave this file open and start a new terminal session. SSH in and download the raw “[rpcauth.py file](https://github.com/bitcoin/bitcoin/blob/master/share/rpcauth/rpcauth.py)” from the Bitcoin repository.
...
**Proceed to part 2, Installing Fulcrum Indexer.**
